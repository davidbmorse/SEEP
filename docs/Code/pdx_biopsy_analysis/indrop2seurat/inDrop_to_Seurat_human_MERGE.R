...
setwd("/Users/morsedb/Documents/Projects/PSS paint sort sequence/Data/sequencing_runs/biopsy2_3_CRUKJuly2019_mouse_human/sequence data/run_190920_SEEP_h1h2h3_MERGE")
getwd()
...
#Path:
#/Users/morsedb/Documents/Projects/PSS paint sort sequence/Data/sequencing_runs/biopsy2_3_CRUKJuly2019_mouse_human/sequence data/run_190809_SEEP_crukBiopsy_2_3/h1/h1.counts.tsv.gz

rawDataCenter <- fread("h1/h1.counts.tsv.gz",header=TRUE)
rawDataMiddle <- fread("h2/h2.counts.tsv.gz",header=TRUE)
rawDataSurface <- fread("h3/h3.counts.tsv.gz",header=TRUE)
...
write.table(rawDataCenter[,1], file= "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/5th_MERGE_human/h1_MERGE/barcodes.tsv",
            quote=FALSE, sep='\t', col.names = FALSE, row.names = FALSE)

write.table(rawDataMiddle[,1], file= "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/5th_MERGE_human/h2_MERGE/barcodes.tsv",
            quote=FALSE, sep='\t', col.names = FALSE, row.names = FALSE)

write.table(rawDataSurface[,1], file= "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/5th_MERGE_human/h3_MERGE/barcodes.tsv",
            quote=FALSE, sep='\t', col.names = FALSE, row.names = FALSE)
...
#save a as a file
write.table(genesO2center[-1,], file = "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/5th_MERGE_human/h1_MERGE/genes.tsv",
...
writeMM(t(dataO2center), "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/5th_MERGE_human/h1_MERGE/matrix.mtx")
writeMM(t(dataO2middle), "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/5th_MERGE_human/h2_MERGE/matrix.mtx")
writeMM(t(dataO2surface), "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/5th_MERGE_human/h3_MERGE/matrix.mtx")
...
spheroid.data <- Read10X("/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/5th_MERGE_human/h3_MERGE")
