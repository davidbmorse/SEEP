...
setwd("/Users/morsedb/Documents/Projects/PSS paint sort sequence/Data/sequencing_runs/biopsy2_3_CRUKJuly2019_mouse_human/sequence data/crukBiopsy_1c1m1s")
getwd()
...
rawDataCenter <- fread("1c/1c.counts.tsv.gz",header=TRUE)
rawDataMiddle <- fread("1m/1m.counts.tsv.gz",header=TRUE)
rawDataSurface <- fread("1s/1s.counts.tsv.gz",header=TRUE)
...
write.table(rawDataCenter[,1], file= "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/1c_center/barcodes.tsv",
            quote=FALSE, sep='\t', col.names = FALSE, row.names = FALSE)

write.table(rawDataMiddle[,1], file= "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/1m_middle/barcodes.tsv",
            quote=FALSE, sep='\t', col.names = FALSE, row.names = FALSE)

write.table(rawDataSurface[,1], file= "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/1s_surface/barcodes.tsv",
            quote=FALSE, sep='\t', col.names = FALSE, row.names = FALSE)
...
#save a as a file
write.table(genesO2center[-1,], file = "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/1c_center/genes.tsv",
...
writeMM(t(dataO2center), "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/1c_center//matrix.mtx")
writeMM(t(dataO2middle), "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/1m_middle/matrix.mtx")
writeMM(t(dataO2surface), "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/1s_surface/matrix.mtx")
...
spheroid.data <- Read10X("/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matrices/1s_surface")
