...
setwd("/Users/morsedb/Documents/Projects/PSS paint sort sequence/Data/sequencing_runs/biopsy2_3_CRUKJuly2019_mouse_human/sequence data/run_190809_SEEP_crukBiopsy_2_3")
getwd()
...
#Path:
#/Users/morsedb/Documents/Projects/PSS paint sort sequence/Data/sequencing_runs/biopsy2_3_CRUKJuly2019_mouse_human/sequence data/run_190809_SEEP_crukBiopsy_2_3/2h1/2h1.counts.tsv.gz

rawDataCenter <- fread("2h1/2h1.counts.tsv.gz",header=TRUE)
rawDataMiddle <- fread("2h2/2h2.counts.tsv.gz",header=TRUE)
rawDataSurface <- fread("2h3/2h3.counts.tsv.gz",header=TRUE)
...
write.table(rawDataCenter[,1], file= "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matricies/2h1_center/barcodes.tsv",
            quote=FALSE, sep='\t', col.names = FALSE, row.names = FALSE)

write.table(rawDataMiddle[,1], file= "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matricies/2h2_middle/barcodes.tsv",
            quote=FALSE, sep='\t', col.names = FALSE, row.names = FALSE)

write.table(rawDataSurface[,1], file= "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matricies/2h3_surface/barcodes.tsv",
            quote=FALSE, sep='\t', col.names = FALSE, row.names = FALSE)
...
#save a as a file
write.table(genesO2center[-1,], file = "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matricies/2h1_center/genes.tsv",
...
writeMM(t(dataO2center), "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matricies/2h1_center/matrix.mtx")
writeMM(t(dataO2middle), "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matricies/2h2_middle/matrix.mtx")
writeMM(t(dataO2surface), "/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matricies/2h3_surface/matrix.mtx")
...
spheroid.data <- Read10X("/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/biopsy2_3/counts_matricies/2h3_surface")
