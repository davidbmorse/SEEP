...
knitr::opts_chunk$set(root.dir="/Users/morsedb/Documents/Projects/PSS paint sort sequence/Analysis/organoidsComb_190226/R_scripts/190926_GSEA_scRNA_organoid_clusters") 
...
nzak=length(zak)
colo = colorRampPalette(pal, space="Lab")(nzak) 
mat=difmat[,Organoid_GSEA@active.ident=='0']
colv = as.dendrogram(hclust(dist(t(mat)),method='ward.D'))
col.ord = order.dendrogram(colv)
sdat = apply(mat,2,function(x) ifelse(x<=-threshold, -threshold, x))
sdat = t(apply(sdat,2,function(x) ifelse(x>=threshold, threshold, x)))
...
# ONE
mat=difmat[,Organoid_GSEA@active.ident=='1']
colv = as.dendrogram(hclust(dist(t(mat)),method='ward.D'))
col.ord = order.dendrogram(colv)
sdat = apply(mat,2,function(x) ifelse(x<=-threshold, -threshold, x))
sdat = t(apply(sdat,2,function(x) ifelse(x>=threshold, threshold, x)))
...
# TWO
mat=difmat[,Organoid_GSEA@active.ident=='2']
colv = as.dendrogram(hclust(dist(t(mat)),method='ward.D'))
col.ord = order.dendrogram(colv)
sdat = apply(mat,2,function(x) ifelse(x<=-threshold, -threshold, x))
sdat = t(apply(sdat,2,function(x) ifelse(x>=threshold, threshold, x)))
...
# THREE
mat=difmat[,Organoid_GSEA@active.ident=='3']
colv = as.dendrogram(hclust(dist(t(mat)),method='ward.D'))
col.ord = order.dendrogram(colv)
sdat = apply(mat,2,function(x) ifelse(x<=-threshold, -threshold, x))
sdat = t(apply(sdat,2,function(x) ifelse(x>=threshold, threshold, x)))
...
# FOUR
mat=difmat[,Organoid_GSEA@active.ident=='4']
colv = as.dendrogram(hclust(dist(t(mat)),method='ward.D'))
col.ord = order.dendrogram(colv)
sdat = apply(mat,2,function(x) ifelse(x<=-threshold, -threshold, x))
sdat = t(apply(sdat,2,function(x) ifelse(x>=threshold, threshold, x)))
...
# FIVE
mat=difmat[,Organoid_GSEA@active.ident=='5']
colv = as.dendrogram(hclust(dist(t(mat)),method='ward.D'))
col.ord = order.dendrogram(colv)
sdat = apply(mat,2,function(x) ifelse(x<=-threshold, -threshold, x))
sdat = t(apply(sdat,2,function(x) ifelse(x>=threshold, threshold, x)))
...
# SIX
mat=difmat[,Organoid_GSEA@active.ident=='6']
colv = as.dendrogram(hclust(dist(t(mat)),method='ward.D'))
col.ord = order.dendrogram(colv)
sdat = apply(mat,2,function(x) ifelse(x<=-threshold, -threshold, x))
sdat = t(apply(sdat,2,function(x) ifelse(x>=threshold, threshold, x)))
...
cluster = Organoid_GSEA@meta.data$clusterID
